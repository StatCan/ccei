...
namespace Drupal\ccei\Composer;

use Drupal\ccei\IniEncoder;
...
class ReleaseVersion {
  ...
  public static function execute(Event $event) {
    ...
    // Find all .info files in CCEI..except in the installed code base.
    $finder = (new Finder())
      ->name('*.info.yml')
      ->in('.')
      ->exclude('html');
