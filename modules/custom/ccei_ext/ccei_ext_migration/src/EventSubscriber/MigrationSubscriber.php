...
namespace Drupal\ccei_ext_migration\EventSubscriber;
...
/**
 * CCEI subscriber for controller requests.
 */
class MigrationSubscriber implements EventSubscriberInterface {
  ...
  public function onMigrationPostRowSave(MigratePostRowSaveEvent $event) {
    // Landing Page logic.
    if ($event->getMigration()->id() == 'ccei_node_landing_page' ||
        $event->getMigration()->id() == 'ccei_node_landing_page_translation') {
    ...
    if ($event->getMigration()->id() == 'ccei_block_spotlight') {
